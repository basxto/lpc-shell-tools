...
for anim in walkcycle shoot gunwalk thrust slash hurt spellcast walkcycle;do
...
convert -background none shoot.png ${base}_shoot.png -compose out -layers flatten ${base}_shoot.png
printf "Combine all animations into one spritesheet... "
convert -background none -append ${base}_{spellcast,thrust,walkcycle,slash,shoot,hurt}.png ${base}_all.png
echo ${base}_all.png
